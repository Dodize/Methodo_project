...
-- Importer le module de memoire dans .adb
   ...
   -- permet de retirer le premier mot avant dÈlimiteur de la ligne en le plaÁant dans mot
   -- @param Ligne : ligne dont on extrait le mot
   -- @param Mot : o˘ placer le mot extrait
   -- @param Delimiteur: caractËre signant la fin du mot
